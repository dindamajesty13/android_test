...
import com.majesty.android_test.ListCatchActivity;
import com.majesty.android_test.R;
import com.majesty.android_test.adapter.PokemonRecyclerViewListAdapter;
import com.majesty.android_test.databinding.FragmentMainBinding;
import com.majesty.android_test.repository.MainRepository;
import com.majesty.android_test.viewmodel.MainViewModel;
...
public class MainFragment extends Fragment implements PokemonRecyclerViewListAdapter.OnItemClickListener {
    ...
    private void openListCatch() {
        fragmentMainBinding.list.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ListCatchActivity.class);
